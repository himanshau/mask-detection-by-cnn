...
Applied image handling and visualization techniques using OpenCV, PIL, and Matplotlib to explore and prepare data.

Structured the dataset for future machine learning use by organizing labels and ensuring balanced class distribution.
